                ...
                <div class="body__container">
                    ...
                    <div class="body__listing">
                        <div class="body__category">
                            <a href="select_script.php?class=drug&category=vital" class="body__href">Vital</a>
                        </div>
                        <div class="body__category">
                            <a href="select_script.php?class=drug&category=animal" class="body__href">Animal+</a>
                        </div>
                    </div>
                </div>
            </div>
