            ...
            <div class="body">
                <div class="body__container">
                    ...
                    <div class="body__contact">
                        <div class="body__appelation">
                            Интернет-магазин товаров для животных
                        </div>
                        <div class="body__phone">
                            <img src="images/phone.png" alt="" class="body__image_phone">
                            <div class="body__sublabel">Номер телефона - +7 (565) 221 84-85</div>
                        </div>
                        <div class="body__email">
                            <img src="images/mail.png" alt="" class="body__image_email">
                            <div class="body__sublabel">Почтовый адрес - druzoK@gmail.com</div>
                        </div>
                    </div>    
                    <div class="body__title body__margin">
                        Информация о юридическом лице
                    </div>
                    <div class="body__legal">
                        ООО «ЧЕТЫРЕЛАПЫ-ИМ»<br>
                        ОГРН: 1215000031905<br>
                        Юридический адрес: 140186, Московская обл., Г.О. Жуковский, ул. Дугина, дом 28/12, помещ. 7, офис 17
                    </div>
                    <div class="body__title body__margin">
                        Карта
                    </div>
                    <div class="body__map">
                        <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Aafb47b49fb39e95f29e4c5517265cc8905b749edb3a65409e288845600408fc5&amp;source=constructor" 
                            width="393" height="298" frameborder="0">
                        </iframe>
                    </div>
                </div>
            </div>
