                    ...
                    <div class="body__page">
                        ...
                        <div class="body__catalog">
                            ...
                            <?php
                                ...
                                $class = $_SESSION['class'];
                                $category = $_SESSION['category'];
                                $result = mysqli_query($connect, "SELECT * FROM `product` WHERE `class` = '$class' AND `category` = '$category'");
                                while ($product = mysqli_fetch_assoc($result)) {
                                    ...
                                    <div class="body__lower">
                                        ...
                                        <div class="body__add">
                                            <button type="submit" class="body__cart" onclick="buyProduct()">В корзину</button>
                                        </div>
                                    </div>
                                </div>
                                    <?php
