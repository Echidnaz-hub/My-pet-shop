        ...
        <div class="content">
            ...
            <div class="body">
                <div class="body__container">
                    ...
                    <p class="body__info">
                        <div class="body__row team">Наши магазины представлены и в формате супермаркета, для любителей внимательно рассмотреть товар, потрогать и примерить. А также есть магазины прилавочного типа, для любителей магазинов небольшого формата, где Вас приветствует один и тот же продавец, который знает Вас в лицо и почти всегда знает , что вы берете для вашего любимца.. Ассортимент каждого из наших зоомагазинов насчитывает более 20.000 наименований товаров для животных. В каждом магазине есть ветеринарный отдел, здесь можно приобрести лекарства для животных и получить квалифицированную консультацию о разнообразных ветеринарных препаратах.</div>              
                    </p>
                    <p class="body__info">
                        <div class="body__row team">Вы можете просто прийти в наш зоомагазин и полюбоваться на минизоопарк, в котором обитают птицы, грызуны (хомяки, мышки, кролики, свинки, шиншиллы) и аквариумные рыбки. Штат высококвалифицированных продавцов-консультантов постоянно проходит обучение, как у специалистов лидирующих фирм-поставщиков, так и на тренингах и специализированных курсах по совершенствованию навыков продаж.</div>
                    <p class="body__info">
                        <div class="body__row team">В магазинах постоянно проходят акции, предоставляются льготы и скидки. Все наши зоомагазины можно посетить вместе с собакой — вы всегда можете просто прийти и примерить на любимца одежду или ошейник.</div>
                    </p>
                </div>
            </div>
        </div>
