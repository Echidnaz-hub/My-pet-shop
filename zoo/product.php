        ...
        <div class="content">
            ...
            <div class="body">
                <div class="body__container">
                    ...
                    <div class="body__article">Арт: <?php echo $product['article'] ?></div>
                    <div class="body__item">
                        <div class="body__item_image">
                            <img src="media/<?php echo $product['image']?>.jpg" alt="" class="body__item_thumb">
                        </div>
                        <div class="body__item_description">
                        <p class="body__item_paragraph"> <?php echo $product['description']; ?> </p>
                        </div>
                        <div class="body__buy">
                            <div class="body__item_price">
                                <?php echo $product['price']; ?> руб
                            </div>
                            <div class="body__item_button">
                                <button type="submit" class="body__item_btn" onclick="buyProduct()">
                                    <span class="body__item_text" >В корзину</span>
                                </button>
                            </div>
                        </div>
                    </div>
