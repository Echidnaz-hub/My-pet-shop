                ...
                <div class="body__container">
                    ...
                    <div class="body__listing">
                        <div class="body__category">
                            <a href="select_script.php?class=cat&category=food" class="body__href">Корм</a>
                        </div>
                        <div class="body__category">
                            <a href="select_script.php?class=cat&category=toy" class="body__href">Игрушки</a>
                        </div>
                        <div class="body__category">
                            <a href="select_script.php?class=cat&category=health" class="body__href">Гигиена</a>
                        </div>
                    </div>
                </div>
            </div>
