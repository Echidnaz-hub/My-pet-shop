            ...
            <div class="body">
                <div class="body__container">
                    ...
                    <div class="body__data">
                        <form action="register_script.php" method="POST" class="body__form">
                            <div class="body__field">
                                <input type="text" class="body__input" name="login" placeholder="Логин">
                            </div>
                            <div class="body__field">
                                <input type="password" class="body__input" name="password" placeholder="Пароль">
                            </div>
                            <div class="body__field">
                                <input type="password" class="body__input" name="password_confirm" placeholder="Подтверждение пароля">
                            </div>
                            <div class="body__btn">
                                <button type="submit" class="body__button">Зарегистрироваться</button>
                            </div>
                            <div class="body__register">
                                <a href="login.php" class="body__link_register">Войти</a>
                            </div>
                            <?php 
                                if ($_SESSION['message']) {
                                    echo '<div class="body__message">'. $_SESSION['message'] .'</div>'; 
                                }
