...
<body>
    <div class="wrapper">
        <div class="content">
                ...
                <navbar class="header__container">
                    <div class="navigation__info">
                        ...
                        <img src="images/time.png" alt="" class="navigation__icon time">
                            <span class="navigation__link schedule">Ежедневно 9:00-20:00</span>
                        </div>
                    </div>
            ...
            <div class="header__phone_hidden">
                +7 (565) 221 84-85
            </div>
            ...
            <div class="body">
                <div class="body__container">
                    <div class="body__title">
                        Интернет магазин Дружок
                    </div>
                    <div class="body__grid">
                        <div class="body__type_red">
                            <div class="body__image">
                                <img src="images/cat.png" alt="" class="body__picture_1">
                            </div>
                            <div class="body__text body__text_1">
                                ...
                                <div class="body__list">
                                    <a href="select_script.php?class=cat&category=food" class="body__kind">Корм</a>
                                    <a href="select_script.php?class=cat&category=toy" class="body__kind">Игрушки</a>
                                    <a href="select_script.php?class=cat&category=health" class="body__kind">Гигиена</a>
                                </div>
                            </div>
                        </div>
                        <div class="body__type_green">
                            <div class="body__image">
                                <img src="images/dog1.png" alt="" class="body__picture_2">
                            </div>
                            <div class="body__text body__text_2">
                                <div class="body__name">
                                    Собакам
                                </div>
                                <div class="body__product">
                                ...
                                <div class="body__list">
                                    <a href="select_script.php?class=dog&category=food" class="body__kind">Корм</a>
                                    <a href="select_script.php?class=dog&category=toy" class="body__kind">Игрушки</a>
                                    <a href="select_script.php?class=dog&category=health" class="body__kind">Гигиена</a>
                                </div>
                            </div>
                        </div>
                        <div class="body__type_yellow">
                            <div class="body__image">
                                <img src="images/rat.png" alt="" class="body__picture_2">
                            </div>
                            <div class="body__text body__text_2">
                                <div class="body__name">
                                    Грызунам
                                ...
                                <div class="body__list">
                                    <a href="select_script.php?class=rodent&category=food" class="body__kind">Корм</a>
                                    <a href="select_script.php?class=rodent&category=toy" class="body__kind">Игрушки</a>
                                    <a href="select_script.php?class=rodent&category=health" class="body__kind">Гигиена</a>
                                </div>
                            </div>
                        </div>
                        <div class="body__type_red">
                            <div class="body__image">
                                <img src="images/bird.png" alt="" class="body__picture_2">
                            </div>
                            <div class="body__text body__text_2">
                                <div class="body__name">
                                    Птицам
                                ...
                                <div class="body__list">
                                    <a href="select_script.php?class=bird&category=food" class="body__kind">Корм</a>
                                    <a href="select_script.php?class=bird&category=toy" class="body__kind">Игрушки</a>
                                </div>
                            </div>
                        </div>
                        <div class="body__type_blue">
                            <div class="body__image">
                                <img src="images/fish.png" alt="" class="body__picture_2">
                            </div>
                            <div class="body__text body__text_2">
                                <div class="body__name">
                                    Рыбкам
                                ...
                                <div class="body__list">
                                    <a href="select_script.php?class=fish&category=food" class="body__kind">Корм</a>
                                    <a href="select_script.php?class=fish&category=toy" class="body__kind">Игрушки</a>
                                </div>
                            </div>
                        </div>
                        <div class="body__type_green">
                            <div class="body__image">
                                <img src="images/drug1.png" alt="" class="body__picture_3">
                            </div>
                            <div class="body__text body__text_1">
                                <div class="body__name">
                                    Препараты
                                ...
                                <div class="body__list">
                                    <a href="select_script.php?class=drug&category=vital" class="body__kind">Vital</a>
                                    <a href="select_script.php?class=drug&category=animal" class="body__kind">Animal+</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="body__line">
                        <div class="body__brand">
                            ...
                            <div class="body__companies">
                                <div><img src="images/monge.png" alt="" class="body__company body__shrimp_1"></div>
                                <div><img src="images/bravecto.jpg" alt="" class="body__company body__shrimp_1"></div>
                                <div><img src="images/scr.png" alt="" class="body__company body__shrimp_1"></div>
                                <div><img src="images/grand_prix.png" alt="" class="body__company body__shrimp_1"></div>
                                <div><img src="images/foresto.png" alt="" class="body__company body__shrimp_2"></div>
                                <div><img src="images/purina.jpg" alt="" class="body__company body__shrimp_2"></div>
                                <div><img src="images/fitmin.jpg" alt="" class="body__company body__shrimp_1"></div>
                                <div><img src="images/brooksfield.jpg" alt="" class="body__company body__shrimp_1"></div>
                                <div><img src="images/farmina.jpg" alt="" class="body__company body__shrimp_last"></div>

                            </div>
                        </div>
                        <div class="body__advantages">
                            <div class="body__plus">
                                <div class="body__img">
                                    <img src="images/shield.png" alt="" class="body__thumb">
                                </div>
                                <div class="body__guarantee">
                                    Гарантия качества и лучшей цены
                                </div>
                            </div>
                            <div class="body__plus">
                                <div class="body__img">
                                    <img src="images/truck.png" alt="" class="body__thumb">
                                </div>
                                <div class="body__guarantee">
                                    Доставка день в день до двери
                                </div>
                            </div>
                            <div class="body__plus">
                                <div class="body__img">
                                    <img src="images/card.png" alt="" class="body__thumb">
                                </div>
                                <div class="body__guarantee">
